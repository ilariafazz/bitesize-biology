        ...
        <div id="about-ilaria" className="header-container">
            <div className="header">
                ...
                <div className="explanation-box">
                    <h1 className="header-text">Defining the specifics of biology a digestible way, <br />Your first biology exposure starts today!</h1>
            ...
            <div className="about-ilaria">
                <div>
                    <p>This summer I spent 24 days isolated in the wild, canoeing down the picturesque Missinaibi River in northern Ontario. I faced whatever nature threw at me daily, learning anything and everything I could about my surroundings.
                    ...
                    <br />
                    <br />Whether it was by spending countless days exploring the woods outside my Nonna’s farm, summers at sleepaway camp, immersed in the great outdoors, or even now in the lecture room of my grade eleven biology class, I love understanding how systems work together all throughout life. 
                ...
                <div id="pink-bunny">
                    <img className="about-ilaria-bunny" src={backgroundlessBunny} />
                </div>
            </div>
        </div>
    )
